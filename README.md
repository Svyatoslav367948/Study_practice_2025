...
В данной работе вы можете найти запрограммированную нейронную сеть, код представлен в файле [Practice_First_version.ipynb] (Practice_First_version.ipynb) (код выполнен в Google.Colab).
